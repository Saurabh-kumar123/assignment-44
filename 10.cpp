/*10.You have a set of integer s, which originally contains all the numbers from 1 to n. Unfortunately,
 ...
 representing the data status of this set after the error.Find the number that occurs twice and the number
